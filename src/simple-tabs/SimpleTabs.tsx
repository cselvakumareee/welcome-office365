  ...
  return (
    <div className="simpletabs-wrapper">
      <div className="simpletabs-block">
        <header>
          <h2>What can you do with office 365?</h2>
        </header>
        ...
        <div className="text-container">
            ...
            <div className="text-block">
                ...
                <span>Get a Professional email for your domain with the power of Outlook. With sufficient storage, you never run out of space again.</span>
            </div>
            <div className="text-block">
                <h3>Stay Connected</h3>
                <span>Connect with your teams with HD video calls on Skype and Microsoft teams.</span>
            </div>
            <div className="text-block">
                <h3>Stay Organised</h3>
                <span>Add reminders, schedule meetings and never miss a thing with smart calender.</span>
            </div>
            </div>
